...
2. mantenere questa app Android dedicata come legacy/fallback finche' il wrapper non ha release verificata e distribuibile
3. toccare questo runtime solo per bugfix mirati, recupero configurazioni native o confronto del comportamento push
4. prima di archiviare o rimuovere file, creare tag/branch di rollback e verificare che package name, signing e FCM siano stati migrati al wrapper
5. se serve ancora una build legacy, chiudere smoke test reale e generare `.aab` solo come fallback tecnico, non come roadmap primaria
