...
- questa app Android dedicata resta legacy/transitoria per confronto push, fallback tecnico e rollback
- nessun file Android e' stato rimosso in questa fase; cleanup rimandato a una finestra dedicata dopo release wrapper verificata
