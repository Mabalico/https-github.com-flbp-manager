...
## Web paths rilevanti
- `FLBP ONLINE/App.tsx`
- `FLBP ONLINE/types.ts`
- `FLBP ONLINE/services/supabasePublic.ts`
- `FLBP ONLINE/services/tournamentEngine.ts`
- `FLBP ONLINE/components/Home.tsx`
- `FLBP ONLINE/components/PublicTournaments.tsx`
- `FLBP ONLINE/components/PublicTournamentDetail.tsx`
- `FLBP ONLINE/components/Leaderboard.tsx`
