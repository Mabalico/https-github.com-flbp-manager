...
import { AlertCircle, ArrowRight, Shield, Star, Users, Wind } from 'lucide-react';
...
// i18n: TODO - externalize role labels when i18n coverage is extended
        ...
        <div className={panelClass}>
          ...
          <div className="mt-5 rounded-[22px] border border-amber-200 bg-amber-50 px-4 py-4">
            <div className="flex items-start gap-3">
              <div className="mt-0.5 inline-flex h-9 w-9 items-center justify-center rounded-xl bg-amber-100 text-amber-700"><AlertCircle className="h-4 w-4" /></div>
              <div>
                <div className="text-sm font-black uppercase tracking-wide text-amber-900">Builder disponibile</div>
                <div className="mt-1 text-sm font-semibold leading-6 text-amber-800">Usa il pulsante "Crea / modifica squadra" per costruire la tua rosa con ruoli e vincoli.</div>
              </div>
            </div>
          </div>
        </div>
