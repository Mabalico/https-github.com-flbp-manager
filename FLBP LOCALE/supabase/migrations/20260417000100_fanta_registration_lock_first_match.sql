-- Keep FantaBeerpong rosters editable after tournament launch until the first real match starts.
-- A tournament is considered started for Fanta only when a non-hidden, non-BYE match is playing/finished or marked played.
