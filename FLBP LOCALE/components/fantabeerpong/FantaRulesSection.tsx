      ...
      <div className="rounded-[26px] border border-slate-200 bg-gradient-to-r from-slate-50 to-white p-5 shadow-sm md:p-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 rounded-full border border-beer-100 bg-beer-50 px-3 py-1 text-[11px] font-black uppercase tracking-[0.12em] text-beer-700"><ScrollText className="h-3.5 w-3.5" />{t('fanta_rules_title_label')}</div>
      ...
      <div className="grid gap-5 xl:grid-cols-[minmax(0,1.15fr)_minmax(320px,0.85fr)]">
        <div className="space-y-5">
          <div className={panelClass}>
            <div className="flex items-center gap-3"><Sparkles className="h-5 w-5 text-beer-600" /><div className="text-xl font-black tracking-tight text-slate-950">{t('fanta_rules_official_scores')}</div></div>
          ...
          <div className={panelClass}>
            <div className="flex items-center gap-3"><Shield className="h-5 w-5 text-sky-600" /><div className="text-xl font-black tracking-tight text-slate-950">{t('fanta_rules_special_roles')}</div></div>
            <div className="mt-4 grid gap-3 md:grid-cols-2">
              <div className="rounded-[22px] border border-amber-200 bg-amber-50/50 px-4 py-4">
                <div className="text-sm font-black uppercase tracking-wide text-amber-900">{t('fanta_rules_captain_title')}</div>
                <div className="mt-1 text-lg font-black text-slate-950">{t('fanta_rules_captain_desc')}</div>
                <div className="mt-2 text-sm font-semibold leading-6 text-slate-700">{t('fanta_rules_captain_helper')}</div>
              </div>
          ...
          <div className={panelClass}>
            <div className="flex items-center gap-3"><Sparkles className="h-5 w-5 text-indigo-600" /><div className="text-xl font-black tracking-tight text-slate-950">{t('fanta_rules_scia_title')}</div></div>
            <div className="mt-4 rounded-[22px] border border-indigo-100 bg-indigo-50/30 p-5">
              <div className="text-sm font-semibold leading-7 text-slate-700">
                {t('fanta_rules_scia_desc')}
                <ul className="mt-2 list-inside list-disc space-y-1">
                  <li>{t('fanta_rules_scia_list_item_1')}</li>
                  <li>{t('fanta_rules_scia_list_item_2')}</li>
                  <li>{t('fanta_rules_scia_list_item_3')}</li>
                </ul>
                <div className="mt-4 rounded-xl bg-white p-4 shadow-sm ring-1 ring-slate-100">
                  <div className="text-[11px] font-black uppercase tracking-wide text-slate-500">{t('fanta_rules_scia_example_title')}</div>
                  <div className="mt-1 text-sm font-medium italic text-slate-600">
                    {t('fanta_rules_scia_example_body')}
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className={panelClass}>
            <div className="flex items-center gap-3"><Trophy className="h-5 w-5 text-amber-500" /><div className="text-xl font-black tracking-tight text-slate-950">{t('fanta_rules_constraints_title')}</div></div>
        ...
        <div className="space-y-5">
          <div className={panelClass}>
            <div className="text-xl font-black tracking-tight text-slate-950">{t('fanta_rules_faq_title')}</div>
            <div className="mt-4 space-y-3">
              {data.faqs.map((faq) => {
