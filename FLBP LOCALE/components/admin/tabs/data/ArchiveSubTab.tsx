                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                        <div className="lg:col-span-1 space-y-3">
                            <div className="flex items-center justify-between gap-2">
                                ...
                                {(!onEditAwards || createArchiveOpen) && <button type="button"
                                    onClick={() => {
                        ...
                        <div className="lg:col-span-2 space-y-4">
                            {(() => {
                                ...
                                const u25Players = players.filter(p => isU25(p.birthDate, tsel.startDate || ''));
                                ...
                                return (
                                    <div className="space-y-6">
                                        ...
                                        <button type="button" className={btnDark} onClick={() => onEditAwards?.(tsel.id)}>{t('edition_section_awards')}</button>
                                    </div>
                                );
                            })()}
                        </div>
